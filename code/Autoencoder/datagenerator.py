...
class DatasetRGB(ABC):
    ...
    def prepare_data(self):
        ...
        X_train = {"RGB": self.samples["img_enc"][idx_train].astype('float32')}
        X_val = {"RGB": self.samples["img_enc"][idx_val].astype('float32')}
        X_test = {"RGB": self.samples["img_enc"][idx_test].astype('float32')}

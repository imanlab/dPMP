...
class deep_ProMPs_2dmodel_RGBD(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.X1 = layers.Dense(256,kernel_initializer=tf.keras.initializers.RandomNormal( mean=0.0, stddev=0.02))
        self.X2 = layers.LeakyReLU(0.2)
        self.Y1 = layers.Dense(256,kernel_initializer=tf.keras.initializers.RandomNormal( mean=0.0, stddev=0.02))

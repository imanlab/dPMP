...
def load_encoded_image(img_path, encoder, resize_shape=(128, 128, 3)):
    ...
    latent = encoder(np.expand_dims(load_image(img_path, resize_shape=resize_shape), axis=0))
    return np.squeeze(latent)
...
class Dataset(ABC):
    ...
    def __init__(self, dataset_dir,rgb_dir):
        ...
        self.samples["berries_id"] = get_berry_ids(self.rgb_dir)                                        #  [['1' '1']  ... ['5' '5'] ]

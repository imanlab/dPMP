...
''' Function to plot the 7 joints distributions '''
...
''' Function to plot the distribution of weights as histogram'''
...
def plot_traj_distribution_1_joint(save_path,config, mean_traj_1,traj_std_1,mean_traj_2=np.zeros(shape=(150,)),traj_std_2=np.zeros(shape=(150,)),show=False,save=False):
            ...
            plt.plot(q1righttrue_1, 'b', linewidth=0.5)
            plt.plot(q1lefttrue_1, 'b', linewidth=0.5)
            plt.fill_between(x, q1righttrue.reshape(150, ), q1lefttrue.reshape(150, ), alpha=0.25,facecolor='blue')
            plt.fill_between(x, q1righttrue_1.reshape(150, ), q1lefttrue_1.reshape(150, ), alpha=0.25,facecolor='blue')
